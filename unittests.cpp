...
TEST(TDDTests, givenBoardSize6WithPlacedQueen_whenSolvingProblem_thenReturnsOnlyPossibleSolutionString) {
    auto actual = solveNQueens(6, {2,1});
    auto expected = "....Q.\n..Q...\nQ.....\n.....Q\n...Q..\n.Q....\n";
    ASSERT_EQ(expected, actual);
}
...
TEST(TDDTests, givenBoardSize28WithPlacedQueen_whenSolvingProblem_thenReturnsSolutionString) {
    auto returnValue = solveNQueens(28, {1, 0});
    ASSERT_TRUE(returnValue.length() > 0);
}
